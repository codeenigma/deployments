...
@task
@roles('app_primary')
def drush_status(repo, branch, build, buildtype, site, drush_runtime_location=None, alias=None, db_update=True, revert=False, revert_settings=False, sites_deployed=None):
...
@task
@roles('app_primary')
def drush_updatedb(repo, branch, build, buildtype, site, alias, drupal_version, db_update, sites_deployed=None):
